...
export const company: MenuItem[] = [
  { name: 'Why Prowealth', href: '/company/why' },
...
export const testimonies = [
  {
    ...
    message: "Prowealth has made navigating the complex world of finance a breeze. Their extensive range of services reflects their expertise. Prowealth's friendly demeanor and organized approach have made managing my investments effortless. For all things related to copy trading and financial planning, they're the ones I trust.",
  },
  {
    ...
    message: "Prowealth epitomizes excellence in copy trading services. Their unwavering dedication to ensuring customer satisfaction sets them apart. With a secure approach, authentic insights, and swift responsiveness, every interaction is seamless. If you're looking for a copy trading platform that delivers results, I wholeheartedly recommend Prowealth!",
  },
  {
    ...
    message: "I've had the privilege of working with Prowealth for some time now, and their professionalism and knowledge continue to impress me. They provide thoughtful advice tailored to my financial goals and risk tolerance. Prowealth's commitment to their clients' success is truly remarkable.",
  },
  {
    ...
    message: "Prowealth's financial expertise has been a game-changer for me. Their insights into market trends and their ability to explain complex concepts in simple terms have empowered me to make better financial decisions. Their services have exceeded my expectations in every way.",
  },
  {
    title: 'Investment Strategist | Luna',
    name: 'Sarah Thompson',
    imgUrl: 'https://source.unsplash.com/320x320/?woman',
    message: "Prowealth's commitment to their clients is truly commendable. Their dedication to achieving financial goals is evident in every interaction. Their insights have helped me navigate volatile markets with confidence, and their friendly approach makes discussing finances a breeze.",
  },
  {
    ...
    message: "Working with Prowealth has been enlightening. Their advice extends beyond mere financial matters; they're a holistic wealth advisor. Their personalized approach and genuine care for their clients' financial well-being are what set them apart. I'm grateful for their guidance.",
  },
  {
    ...
    message: "Prowealth's expertise stands out in a crowded financial landscape. Their knowledge of investment opportunities and risk management is unparalleled. They've not only helped me make informed decisions but also educated me along the way. I highly recommend their services.",
  },
  {
    ...
    message: "Prowealth is a financial wizard. Their ability to foresee market trends and recommend timely actions is remarkable. I've achieved significant growth in my investments under their guidance. They're not just financial advisors; they're strategic partners in wealth-building.",
  },
  {
    ...
    message: "I've been a client of Prowealth for years, and their dedication to my financial success has never wavered. Their well-rounded expertise covers everything from retirement planning to tax-efficient investing. They're an invaluable asset in securing my financial future.",
  },
  {
...
export const HomeSec2 = {
  ...
  desc: "With over 500+ registered and regulated traders on Prowealth, you get the liberty to beat the PDT & day trading by getting started with our copy trading tool below the $25k minimum requirement. Mirror your desired expert on the best linked platform like Thinkorswim, Webull, Robinhood. At Prowealth we thrive to bring you the modern trading experience.",
  imgUrl: secImg2,
  url: "#"
}
...
export const HomeSec3 = {
  ...
  desc: "Whether you're a beginner learning the basics or you simply don't have time to watch the markets, now it's easy to leverage other traders' expertise. With Prowealth Copy Trading, you can automatically copy top-performing traders, instantly replicating their trading in your own portfolio.",
  imgUrl: secImg3,
}
...
export const cmHero = {
  title: "Commodities",
  subtitle: "Trade the most popular CFDs on Commodities from around the world, including energies, agriculture and metals. Prowealth combines tight pricing and flexible conditions to give you one powerful product.",
}

export const indicesHero = {
  title: "Indices",
  subtitle: "Gain exposure to the basket of instruments making up the index in just one trade. The world’s most popular Indices are available on all Prowealth trading platforms.",
}
...
export const stocksHero = {
  title: "Stocks",
  subtitle: "Trade over +2100 large-cap Stocks CFDs across the ASX, NYSE and NASDAQ stock exchanges with superior execution and tight pricing exclusively on the Prowealth MetaTrader 5 platform.",
}

export const futuresHero = {
  title: "Futures",
  subtitle: "Futures are one of the most popular form of CFDs. Prowealth offer a range of Futures from around the world, including ICE Dollar Index and CBOE VIX Index. Online Futures based CFDs are offered exclusively on Prowealth ' MetaTrader 4 & 5 Platform.",
}
...
export const regHero = {
  title: "Regulations",
  subtitle: "Prowealth is authorised and regulated by multiple Regulators across the globe. Trade with peace of mind knowing that Prowealth is monitored by some of the strictest financial regulators’ bodies in the world.",
}
...
export const tradersHero = {
  ...
  subtitle: "The Prowealth traders are one of the most competitive traders in the world. Making the most profit on BullCopytrade is an admirable title, getting it takes time, brains and patience. You can copy any of the traders at BullCopytrade.",
}

export const labelHero = {
  title: "White Label",
  subtitle: "Prowealth ' white label partnership program is a complete solution giving your clients access to our market-leading liquidity and technology.",
}
...
export const serversHero = {
  title: "Servers",
  subtitle: "Virtual Private Server (VPS) & Other Trading Servers allows traders to run automated trading strategies 24 hours a day 7 days a week with the fastest possible connectivity to the Prowealth trading servers.",
}
...
export const condHero = {
  ...
  subtitle: "The Prowealth Trading environment offers the most aggressive pricing and flexible trading conditions globally. They are ideal for traders who demand the best execution quality and lowest spreads.",
}

export const spreadsHero = {
  title: "Spreads",
  subtitle: "Prowealth ’ spreads are among the lowest across all major and minor currency pairs. In particular, our average EUR/USD spread* of 0.1 pips is one of the lowest in the world.",
}

export const hoursHero = {
  title: "Trading Hours",
  subtitle: "At Prowealth there’s always a market for you to trade. Our dedicated specialists are available for you 24 hours a day, 5 days a week.",
}

export const swapHero = {
  title: "Swap Rates",
  subtitle: "Prowealth swap rates are amongst the most competitive in the world. Maximise your overnight swap earnings or reduce your swap costs across our wide range of products.",
}